    ...
    return (
      <div className={'row'}>
        <div className={'col-xs-12 header__top-menu__login-register'}>
          {this.props.login && (
            <div className={'header__top-menu__login-register__user-email'}>
        ...
        <nav className={'col-xs-12 header__top-menu__navigation'}>
          <button className={'header__top-menu__navigation__btn header__top-menu__navigation__btn--pressed'}>
            {this.props.history.location.pathname !== '/' ? (
              ...
              <ScrollLink to={'introSection'} spy={true} activeClass="active" smooth={true} offset={-20} duration={500}>
                Start
              </ScrollLink>
            )}
          </button>
          <button className={'header__top-menu__navigation__btn'}>
            {this.props.history.location.pathname !== '/' ? (
              ...
              <ScrollLink to={'simpleStepsSection'} spy={true} activeClass="active" smooth={true} offset={-20} duration={500}>
                O co chodzi?
              </ScrollLink>
            )}
          </button>
          <button className={'header__top-menu__navigation__btn'}>
            {this.props.history.location.pathname !== '/' ? (
              ...
              <ScrollLink to={'aboutSection'} spy={true} activeClass="active" smooth={true} offset={-20} duration={500}>
                O nas
              </ScrollLink>
            )}
          </button>
          <button className={'header__top-menu__navigation__btn'}>
            {this.props.history.location.pathname !== '/' ? (
              ...
              <ScrollLink to={'whoWheHelpSection'} spy={true} activeClass="active" smooth={true} offset={-20} duration={500}>
                Fudacja i organizacje
              </ScrollLink>
            )}
          </button>
          <button className={'header__top-menu__navigation__btn'}>
            {this.props.history.location.pathname !== '/' ? (
              ...
              <ScrollLink to={'contactSection'} spy={true} activeClass="active" smooth={true} offset={-20} duration={500}>
                Kontakt
              </ScrollLink>
            )}
          </button>
...
const HeaderTopMenuHoc = compose(
  withRedux,
  withRouter,
  withFirebase,
)(HeaderTopMenu);
