    ...
    return(
      <div className={'row'}>
        <div className={'col-xs-12 header__top-menu__login-register'}>
          ...
          <button className={`header__top-menu__login-register__btn header__top-menu__login-register__btn--login ${this.props.login && 'header__top-menu__login-register__btn--pressed'}`}><Link to={'/logowanie'}>Zaloguj</Link></button>
          <button className={`header__top-menu__login-register__btn header__top-menu__login-register__btn--login ${!this.props.login && 'header__top-menu__login-register__btn--pressed'}`}>{this.props.login? <a onClick={() => this.logout()}>Wyloguj</a>: <Link to={'/rejestracja'}>Załóż konto</Link> }</button>
        </div>
