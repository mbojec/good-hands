        ...
        <form onSubmit={event => this.handleSubmit(event)} className={'col-xl-12 login-form__container'}>
          <div className={'login-form__form'}>
            <div className={'login-form__form__email'}>
              ...
              <input
                ...
                type={'text'}
                name={'email'}
                className={`login-form__form__input ${this.state.emailValidationError && 'login-form__form__input--error'}`}
              />
            ...
            <div className={'login-form__form__password'}>
              ...
              <input
                ...
                type={'password'}
                name={'password'}
                className={`login-form__form__input ${this.state.passwordValidationError && 'login-form__form__input--error'}`}
              />
            ...
            <div className={'login-form__form__repeated-password'}>
              ...
              <input
                onBlur={() => this.handleRepeatedPasswordValidation()}
                value={this.state.repeatedPassword}
                onChange={e => this.handleChange(e)}
                type={'password'}
                name={'repeatedPassword'}
                className={`login-form__form__input ${this.state.repeatedPasswordValidationError && 'login-form__form__input--error'}`}
              />
          ...
          <div className={'login-form__btn-section'}>
            <input
              ...
              className={'login-form__btn login-form__btn--register'}
              value={'Załóż konto'}
            />
            <button className={'login-form__btn login-form__btn--login login-form__btn--selected'}>
...
const RegisterPanelHoc = compose(
  withFirebase,
  withRedux,
  withRouter,
)(RegisterPanel);
