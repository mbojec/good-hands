          ...
          <div className={'login-form__form'}>
            ...
            <div className={'login-form__form__password'}>
              ...
              {this.state.passwordValidationError && (
                <label className={'login-form__form__label--error'}>Podane hasło albo email jest nieprawidłowe !</label>
              )}
            </div>
          </div>
          <div className={'login-form__btn-section'}>
            <button className={'login-form__btn login-form__btn--register'}>
            ...
            <input
              ...
              className={'login-form__btn login-form__btn--login login-form__btn--selected'}
              value={'Zaloguj się'}
            />
          </div>
        </form>
