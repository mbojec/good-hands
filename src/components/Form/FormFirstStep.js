          ...
          <form onChange={e => this.onChange(e)} onSubmit={event => this.handleSubmit(event)}>
            <div className={'form__input-section__checkbox-section'}>
              <div className={'form__checkbox__container'}>
                ...
                <label className={'form__checkbox__label__text'} htmlFor={'clothes'}>
                  ubrania, które nadaja się do ponownego użycia
                </label>
              </div>
              <div className={'form__checkbox__container'}>
                ...
                <label className={'form__checkbox__label__text'} htmlFor={'clothesToTrash'}>
              ...
              <div className={'form__checkbox__container'}>
                ...
                <label className={'form__checkbox__label__text'} htmlFor={'toys'}>
                  zabawki
                </label>
              </div>
              <div className={'form__checkbox__container'}>
                ...
                <label className={'form__checkbox__label__text'} htmlFor={'books'}>
                  książki
                </label>
              </div>
              <div className={'form__checkbox__container'}>
                ...
                <label className={'form__checkbox__label__text'} htmlFor={'other'}>
                  Inne
                </label>
              </div>
            </div>
